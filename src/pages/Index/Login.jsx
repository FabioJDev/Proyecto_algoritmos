...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError('⚠️ No se pudo iniciar sesión con Google. Inténtalo nuevamente.')
    } finally {
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted">
            Ingresa para continuar con tus subastas
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 my-6">
          ...
          <span className="text-text-muted text-xs uppercase tracking-wider">o continúa con</span>
          <div className="flex-1 h-px bg-white/10"></div>
        </div>
